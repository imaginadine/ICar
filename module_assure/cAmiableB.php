...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
    ...
    <body>
      ...
      <div class="affichage">
        ...
        <form id="amiable2B" name="amiable2B" method="POST" action="enregistrerAmiable2B.php" class="form">
        <h4>Preneur d'assurance/assuré</h4>
        <?php
            echo '<p>Nom : <input type="text" id="nom" name="nom" value="'.$_SESSION['nom'].'"/></p>';
            echo '<p>Préom : <input type="text" id="prenom" name="prenom" value="'.$_SESSION['prenom'].'"/></p>';
        ...
        <h4>Code sinistre donné par l'autre conducteur : <input type="text" id="codeSinistre" name="codeSinistre" required/></h4>
        <h4>Numéro sinistre donné par l'autre conducteur : <input type="text" id="numSinistre" name="numSinistre" required/></h4>
        <p><input type="checkbox" id="ok2" name="ok2" value="ok2" required/>J'approuve ce que l'autre conducteur a rentré dans les informations générales.</p>
        </br>
        </br>
